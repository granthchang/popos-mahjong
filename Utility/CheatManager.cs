...
{
    [SerializeField] private bool _1ForcesRandomWinner = true;
    ...
    void Update() {
        if (PhotonNetwork.IsMasterClient) {
            // Pressing 1 forces random player to win the round
            if (Input.GetKeyDown(KeyCode.Alpha1) && _1ForcesRandomWinner) {
                Debug.Log("cheat 1: random winner set");
                RoundManager.Singleton.SetRandomWinner();
                return;
            }
